...
namespace Proga
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(error.Message, "Ошибка. Не возможно подключиться к последовательному порту.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btn_cl_Click(object sender, EventArgs e)
        {
            ...
            {
                // Обработка ошибок
                MessageBox.Show(error.Message, "Ошибка. Невозможно закрыть последовательный порт.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btn_STOP_Click(object sender, EventArgs e)
        {
            ...
            {
                // Обработка ошибок
                MessageBox.Show(error.Message, "Ошибка. Невозможно выполнить экстренное торможение.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
